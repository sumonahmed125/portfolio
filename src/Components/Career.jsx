...
function Career() {
  return (
    <div className="sm:w-[70%] mx-auto bg-[#dbfbffba] py-10 sm:px-20 rounded-2xl my-20 ">
      <div className="border-b border-[#36aab9ba] sm:p-10 p-5">
        <h3 className="text-2xl text-blue-950 font-bold ">
          Career Aspirations
        </h3>
        <div className="flex gap-5 mt-5 w-[90%] mx-auto items-center ">
          <div className="text-2xl text-[#0b92a3ba] font-bold  w-[50%] hidden sm:flex">
            <SiComma /> <SiComma />
          </div>
      ...
      <div className="mt-10 border-b border-[#36aab9ba] p-10">
        <h3 className="text-2xl text-blue-950 font-bold ">
          Commitment to Excellence
        </h3>
        <div className="flex gap-5 mt-5 w-[90%] mx-auto items-center">
          <div className="text-2xl text-[#0b92a3ba] font-bold hidden sm:flex w-[50%]">
            <SiComma /> <SiComma />
          </div>
          <p className="sm:text-lg text-base text-gray-500 font-semibold">
      ...
      <div className="py-5">
        <p className="  text-gray-500  text-center  font-semibold w-[80%] mx-auto mt-4">
